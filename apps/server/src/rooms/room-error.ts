...
const ERROR_MESSAGES: Record<RoomErrorCode, string> = {
  ...
  ROUND_ALREADY_CONFIRMED: "이미 이번 턴 행동을 확정했습니다.",
  ROUND_NUMBER_MISMATCH: "현재 턴과 요청 턴이 일치하지 않습니다.",
  REWARD_OPTION_NOT_FOUND: "선택할 수 없는 보상 카드입니다.",
  INVALID_REWARD_SELECTION: "보상 카드 두 장을 정확히 선택해 주세요.",
  INVALID_DECK_REMOVAL: "제거할 수 없는 카드입니다.",
  ATTACK_CARD_REQUIRED: "덱에 공격 카드가 최소 한 장 남아야 합니다.",
